...
?>
<p>
	<span class="checkbox_row"><input type="checkbox" name="<?php echo $meta_name; ?>[enabled-tab]" class="muut_enable_commenting_tab" id="muut_enable_tab-<?php echo $tab['name']; ?>" <?php checked( $active_tab, $tab['name'] ); ?> value="1" /><label for="muut_enable_tab-<?php echo $tab['name']; ?>"><?php _e( 'Enable commenting', 'muut' ); ?></label></span>
</p>
