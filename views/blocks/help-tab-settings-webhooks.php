...
<p>
	<?php printf( __( 'To use webhooks, you need to %supgrade%s your forum to support Outgoing Webhooks with a Small or Medium license.', 'muut' ), '<a class="muut_upgrade_to_developer_link" href="' . muut()->getUpgradeUrl() . '" target="_blank">', '</a>' ); ?>
</p>
<p>
