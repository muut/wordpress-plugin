...
<div class="disabled_tab_wrapper">
	<p>
		<span class="description"><?php printf( __( 'In order to embed the forum, you must disable commenting. %sClick here%s to do that now.', 'muut' ), '<a href="#" class="disabled_comments_link">', '</a>' ); ?></span>
	</p>
	<p>
		<span class="description"><?php _e( 'This will embed your entire forum with navigation on this page.', 'muut' ); ?></span>
	</p>
