...
?>
<p>
	<?php printf( __( 'Single Sign-On (SSO) let\'s you use WordPress registration and login instead of Muut\'s. For this to work you need to %supgrade%s your forums to support SSO and then input the public/private keypair to the settings.', 'muut' ), '<a class="muut_upgrade_to_developer_link" href="#">', '</a>' ); ?>
</p>
<p>
